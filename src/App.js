...
class App extends Component {
  ...
  componentDidMount() {
    fetch(`https://api.unsplash.com/photos/random?h=200&w=200`, {
      headers: {
        Authorization:
          "Client-ID bae9fc94db46b26d116996902a9640e75ead7f8247411570e90fef85f34a485d"
      }
    })
      .then(data => data.json())
      .then(json => {
        this.setState({ randomPhoto: json.urls.custom });
      });
  }
  ...
  render() {
    return (
      <div className="App">
        ...
        />
        <ListPhotos images={this.state.images} />
      </div>
    );
  }
}
